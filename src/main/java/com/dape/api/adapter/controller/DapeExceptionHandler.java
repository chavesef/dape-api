...
public class DapeExceptionHandler {
    ...
    @ExceptionHandler({HttpMessageNotReadableException.class, InvalidStatusForUpdateException.class, GetBetsInvalidStatusException.class, IllegalArgumentException.class})
