...
public class DapeExceptionHandler {
    ...
    @ExceptionHandler({HttpMessageNotReadableException.class, InvalidStatusForUpdateException.class, InvalidBetStatusException.class, IllegalArgumentException.class})
