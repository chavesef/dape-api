...
INSERT INTO BET (NUM_ODD, FLG_SELECTED, DAT_CREATED, DAT_UPDATED, DES_BET, COD_BET_STATUS)
VALUES (1.97, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Vitória do Botafogo', 1);
INSERT INTO BET (NUM_ODD, FLG_SELECTED, DAT_CREATED, DAT_UPDATED, DES_BET, COD_BET_STATUS)
VALUES (4.08, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Vitória do Corinthians', 1);
INSERT INTO BET (NUM_ODD, FLG_SELECTED, DAT_CREATED, DAT_UPDATED, DES_BET, COD_BET_STATUS)
VALUES (4.21, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Vitória do Vasco', 1);
INSERT INTO BET (NUM_ODD, FLG_SELECTED, DAT_CREATED, DAT_UPDATED, DES_BET, COD_BET_STATUS)
VALUES (4.15, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Vitória do Grêmio', 1);
INSERT INTO BET (NUM_ODD, FLG_SELECTED, DAT_CREATED, DAT_UPDATED, DES_BET, COD_BET_STATUS)
VALUES (3.89, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Vitória do Internacional', 1);
INSERT INTO BET (NUM_ODD, FLG_SELECTED, DAT_CREATED, DAT_UPDATED, DES_BET, COD_BET_STATUS)
VALUES (2.10, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Vitória do Atlético-MG', 1);
INSERT INTO BET (NUM_ODD, FLG_SELECTED, DAT_CREATED, DAT_UPDATED, DES_BET, COD_BET_STATUS)
VALUES (1.86, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Vitória do Cruzeiro', 1);
INSERT INTO BET (NUM_ODD, FLG_SELECTED, DAT_CREATED, DAT_UPDATED, DES_BET, COD_BET_STATUS)
VALUES (2.01, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Vitória do Bahia', 1);
INSERT INTO BET (NUM_ODD, FLG_SELECTED, DAT_CREATED, DAT_UPDATED, DES_BET, COD_BET_STATUS)
VALUES (2.52, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Vitória do Bragantino', 1);
