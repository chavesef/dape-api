...
Funcionalidade: Realizar consulta de bilhetes cadastrados no banco de dados
  ...
  Cenario: Consulta de bilhetes com sucesso
  ...
  Cenario: Consulta de bilhetes por página
  ...
  Cenario: Consulta de bilhetes pelo status
  ...
  Cenario: Consulta de bilhetes pelo tipo
  ...
  Cenario: Consulta de bilhetes pelo idt_client
  ...
  Cenario: Consulta de bilhetes pelo dat_created
  ...
  Cenario: Consulta de bilhetes pelo dat_updated
  ...
  Cenario: Consulta de bilhetes pelo status e tipo
  ...
  Cenario: Consulta de bilhetes com dados inexistentes
  ...
  Cenario: Consulta de bilhetes com dados inválidos
  ...
  Cenário: Consulta de bilhetes com serviço indisponível
