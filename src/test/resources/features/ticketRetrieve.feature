...
Funcionalidade: Realizar consulta de bilhetes cadastrados no banco de dados
  ...
  Esquema do Cenario: Validação de paginação e ordenação de bilhetes
    Dado que uma requisição de consulta de bilhetes com os parametros page <page> seja realizada
    Então devem ser retornados <size> bilhetes para a página <page>
    E o numero total de bilhetes deve ser <total_size>
    E o total de páginas de bilhetes deve ser <total_pages>
  ...
  Cenario: Consultar bilhetes com sucesso
    ...
    E os seguintes bilhetes devem ser retornados para a página 0
      | idt_ticket | num_ammount | dat_created | dat_updated | ticket_type | cod_ticket_status | idt_client | num_final_odd |
      | 1          | 100.01      | 2024-08-21  | 2024-08-21  | MULTIPLE    | PENDING           | 1          | 4.08          |
      | 2          | 99.99       | 2024-08-21  | 2024-08-21  | SIMPLE      | PENDING           | 3          | 4.12          |
      | 3          | 12.87       | 2024-08-22  | 2024-08-22  | SIMPLE      | PENDING           | 1          | 3.12          |
    ...
    E os seguintes bilhetes devem ser retornados para a página 1
      | idt_ticket | num_ammount | dat_created | dat_updated | ticket_type | cod_ticket_status | idt_client | num_final_odd |
      | 11         | 112.12      | 2024-08-28  | 2024-08-28  | MULTIPLE    | PENDING           | 2          | 4.08          |
      | 12         | 12.12       | 2024-08-28  | 2024-08-28  | SIMPLE      | RED               | 6          | 3.32          |
  ...
  Cenario: Consultar bilhetes por página
    Quando uma requisição de consulta de bilhetes for realizada com o parâmetro "page" valor "0"
    Entao o serviço de listagem de bilhetes deve retornar o status code 200 - "OK"
    E os seguintes bilhetes devem ser retornados para a página 0
      | idt_ticket | num_ammount | dat_created | dat_updated | ticket_type | cod_ticket_status | idt_client | num_final_odd |
      | 1          | 100.01      | 2024-08-21  | 2024-08-21  | MULTIPLE    | PENDING           | 1          | 4.08          |
  ...
  Cenario: Consultar bilhetes pelo status e tipo
    Quando uma requisição de consulta de bilhetes for realizada com os parâmetros "ticket_type" valor "MULTIPLE" e "ticket_status" valor "PENDING"
    Entao o serviço de listagem de bilhetes deve retornar o status code 200 - "OK"
    E os seguintes bilhetes devem ser retornados para a página 0
      | idt_ticket | num_ammount | dat_created | dat_updated | ticket_type | cod_ticket_status | idt_client | num_final_odd |
      | 1          | 100.01      | 2024-08-21  | 2024-08-21  | MULTIPLE    | PENDING           | 1          | 4.08          |
  ...
  Cenario: Consultar bilhetes com dados inexistentes
    ...
    Entao o serviço de listagem de bilhetes deve retornar o status code 200 - "OK"
    E o conteúdo de resposta de bilhetes deve ser vazio

  @ConsultaBilheteDadosInvalidos
  Cenario: Consultar bilhetes com dados inválidos
    Quando uma requisição de consulta de bilhetes for realizada com o parâmetro "ticket_status" valor "VENCIDA"
